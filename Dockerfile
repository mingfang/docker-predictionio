...
#HBase
RUN wget -O - http://archive.apache.org/dist/hbase/hbase-0.98.6/hbase-0.98.6-hadoop2-bin.tar.gz | tar zx
RUN mv hbase* hbase
...
#PredictionIO
RUN wget -O - http://download.prediction.io/PredictionIO-0.9.0.tar.gz | tar zx
